import { CalendarDays, Cpu, ShoppingBag, UtensilsCrossed } from "lucide-react";
        ...
        <div className="mb-14 md:mb-[72px]">
          ...
          <div className="mt-5 flex flex-col md:flex-row md:items-end md:justify-between gap-5 md:gap-16">
            ...
            <p className="text-[17px] text-[var(--color-muted)] max-w-[400px] leading-[1.6] md:pb-1">
              Each vertical ships with its own screen library, reports, and defaults — sharing the
              same inventory, ledger, and customer record.
            </p>
          </div>
        </div>
