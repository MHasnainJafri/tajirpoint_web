            ...
            <div className="flex gap-3 mt-9 flex-wrap">
              ...
              >
                ...
                <span>
                  ...
                  <span className="block text-[18px] font-bold tracking-[-0.02em] mt-0.5">App Store</span>
                </span>
              </a>
              <a
                href="https://dashboard.tajirpoint.com/signup"
              ...
              >
                ...
                <span>
                  ...
                  <span className="block text-[18px] font-bold tracking-[-0.02em] mt-0.5">Google Play</span>
                </span>
              </a>
            </div>
            <div className="flex flex-wrap gap-8 mt-8 text-[13.5px] text-[var(--color-muted)]">
              <div>
                <b className="text-[var(--color-ink)] font-bold">Desktop</b> · macOS · Windows · Linux
              </div>
              <div>
...
function PhoneStack() {
  return (
    <div className="relative h-[480px] lg:h-[560px] flex items-center justify-center" aria-hidden="true">
      <Phone
        rotate="-6deg"
        ...
        screenContent={
          <div className="px-4 py-7 text-[var(--color-ink)]">
            <div className="text-[11px] tracking-[0.12em] uppercase text-[#0d6b3d] font-semibold mb-3.5">Today</div>
            <div className="text-[36px] font-extrabold tracking-[-0.03em] leading-none">Rs 142,800</div>
      ...
      <Phone
        ...
        screenContent={
          <div className="px-4 py-7 text-white">
            ...
            <div className="text-[30px] font-extrabold tracking-[-0.03em] leading-none">8 stops left</div>
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: "0 60px 120px -40px rgba(10,42,32,0.40), inset 0 0 0 1.5px rgba(255,255,255,0.06)",
