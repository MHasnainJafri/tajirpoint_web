...
function FloatingBubble({
  ...
  return (
    ...
    >
      <span
        className={cn(
          "w-[42px] h-[42px] shrink-0 rounded-xl flex items-center justify-center",
          iconBg
        )}
        aria-hidden="true"
      >
    ...
    <div className="grid grid-cols-[200px_1fr_260px] xl:grid-cols-[240px_1fr_320px] h-full text-[13px]">
      ...
      <aside className="bg-[#fafafa] border-r border-[var(--color-line)] px-3.5 py-4 flex flex-col gap-1">
        <div className="flex items-center gap-2 px-2.5 py-2 mb-4">
          ...
          <span
            className="font-arabic font-bold text-[15px]"
        ...
        <div className="px-2.5 py-2 text-[12.5px] text-[var(--color-ink-3)] font-medium">
          Liaquat Road
        </div>
        <div className="px-2.5 py-2 text-[12.5px] text-[var(--color-ink-3)] font-medium">
          Saddar · #2
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="px-3 py-1 rounded-full bg-[var(--color-mint-soft)] text-[#075c33] text-[11px] font-semibold inline-flex items-center gap-1.5">
            <span
              ...
              style={{ boxShadow: "0 0 0 3px rgba(0,210,122,0.25)" }}
            />
            Offline · 12 queued
          </div>
        </div>
            ...
            <span
              ...
              className={cn(
                ...
                i === 0
                  ...
                  : "bg-[var(--color-bg-3)] text-[var(--color-muted)]"
              )}
            >
              {c}
            </span>
              ...
              <div>
                ...
                <div
                  className={cn(
                    ...
                    item.hot ? "text-white/55" : "text-[var(--color-muted)]"
                  )}
                >
                  {item.price}
                </div>
      ...
      <aside className="bg-[#fafafa] border-l border-[var(--color-line)] px-4 py-4 flex flex-col gap-2">
        <h4 className="text-[13px] font-semibold flex justify-between items-center">
          Cart
          <small className="font-mono text-[var(--color-muted-2)] text-[11px] font-medium">
            3 items
          </small>
        </h4>
        {[
          ...
          <div
            key={row.name}
            className="flex justify-between items-start py-2 border-b border-dashed border-[var(--color-line)]"
          >
            <div>
