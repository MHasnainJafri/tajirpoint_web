...
export const metadata: Metadata = buildMetadata({
  ...
  description: "Tajir Point for salons, clinics, gyms, and service businesses in Pakistan, UAE, and Saudi Arabia. Appointment scheduling, staff commissions, packages, and recurring billing.",
  path: "/solutions/services",
});

const FEATURES = [
  { icon: "📅", title: "Appointments & bookings", body: "Let customers book online or walk in. View your schedule by day, week, or staff member. Send confirmation via WhatsApp." },
  { icon: "💇", title: "Staff & commission", body: "Assign services to staff, track each employee's revenue, and auto-calculate commissions at month end." },
  { icon: "📦", title: "Packages & memberships", body: "Sell session bundles, monthly memberships, or prepaid packages. Track remaining sessions per customer automatically." },
  { icon: "🔄", title: "Recurring billing", body: "Auto-charge monthly members. Send due reminders before the next cycle and track lapsed memberships." },
  { icon: "📋", title: "Customer history", body: "See every visit, service, product purchase, and payment for each customer — going back to day one." },
  { icon: "🛒", title: "Retail alongside services", body: "Sell shampoos, supplements, or accessories at the counter while tracking them as separate inventory from your services." },
  { icon: "🧾", title: "Service invoices", body: "Clean, branded invoices for each service rendered — including technician name, service time, and any products used." },
  { icon: "📊", title: "Staff performance reports", body: "Revenue per staff member, most-booked services, average ticket value, and client retention rate — monthly." },
];
    ...
    <main id="main-content" className="min-h-screen bg-[var(--color-bg)]">
      <section className="pt-20 pb-16 lg:pt-28 lg:pb-20">
        <div className="mx-auto max-w-[1320px] px-7 lg:px-10">
          ...
          <h1 className="text-[44px] lg:text-[68px] font-extrabold tracking-[-0.04em] leading-[1.04] text-[var(--color-ink)] max-w-[800px]">
            Sell your time<br />as efficiently as products.
          </h1>
          <p className="mt-3 text-[14px] text-[var(--color-muted)]">Salons · Clinics · Gyms · Tutors · Car Wash</p>
          <p className="mt-5 text-[17px] text-[var(--color-muted)] leading-[1.65] max-w-[520px]">
            Appointments, staff commissions, package deals, memberships, and recurring billing — everything a service business needs to run smoothly.
          </p>
      ...
      <section className="py-16 bg-[var(--color-ink)]">
        <div className="mx-auto max-w-[1320px] px-7 lg:px-10 text-center">
          ...
          <p className="mt-4 text-[16px] text-white/55 max-w-[400px] mx-auto">We'll set up appointments and staff commissions live in your demo call.</p>
